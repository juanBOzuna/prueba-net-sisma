...
public partial class BankContext : DbContext
{
    ...
    //TO DO implementar conexion

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Account>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Account__3214EC27CAD031F0");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__AccountT__3214EC276FB820DB");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__BankTran__3214EC27098EF3B3");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Client__3214EC2777BECE84");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Transact__3214EC27ADAA59AF");
